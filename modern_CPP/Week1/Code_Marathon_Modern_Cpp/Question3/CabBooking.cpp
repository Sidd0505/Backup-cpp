...
CabBooking::CabBooking(std::string booking_id, std::string pickup_location, std::string drop_location, float base_fare)
            :_booking_id(booking_id), _pickup_location(pickup_location), _drop_location(drop_location), _base_fare(base_fare)
{
}

CabBooking::CabBooking(std::string booking_id, std::string pickup_location, std::string drop_location)
            :_booking_id(booking_id), _pickup_location(pickup_location), _drop_location(drop_location)
{
}
